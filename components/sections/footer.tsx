  ...
  return (
    <footer className="bg-white pb-7 pt-20">
      <div className="mx-auto grid max-w-[1180px] gap-12 px-5 pb-14 sm:grid-cols-2 sm:px-8 lg:grid-cols-[1.7fr_.7fr_1fr_1fr]">
        ...
        <div><strong className="text-xs">Let’s talk</strong><a href="mailto:hello@vireonix.com" className="mt-5 block text-xs font-bold text-accent">hello@vireonix.com</a><Link href="/contact" className="mt-5 inline-flex h-11 items-center gap-2 rounded-xl bg-ink px-4 text-xs font-bold text-white">Book a Call <ArrowUpRight className="size-3.5"/></Link></div>
      </div>
